...
const LANYARD_TEXTURE_URL = '/reactbits/lanyard.png'
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 flex h-full w-full origin-center items-start justify-center overflow-hidden pt-1">
      <Canvas
        camera={{ position, fov }}
  ...
  return (
    <>
      <group position={[0, 4.65, 0]}>
        ...
        >
          <CuboidCollider args={[0.97, 1.36, 0.01]} />
          <group
            scale={3.8}
